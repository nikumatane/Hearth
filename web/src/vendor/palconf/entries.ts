/*
 * Derived from Bluefissure/pal-conf at commit
 * a0f75513a99684922b0ad58692304f8ddfcc06d3.
 * Distributed under the MIT license in this directory.
 */
...
export const ENTRIES: Record<string, Entry> = {
  ...
  PhysicsActiveDropItemMaxNum: {
    ...
    type: "integer",
    range: [-1, 10000],
    desc: "Maximum number of dropped items that can use physics behavior.",
  },
  PlayerDataPalStorageUpdateCheckTickInterval: {
    ...
    type: "float",
    range: [0.1, 60],
    desc: "Interval for checking player pal storage data updates.",
  },
  MonsterFarmActionSpeedRate: {
    ...
    type: "float",
    range: [0.1, 5],
    desc: "Item production speed multiplier from grazing.",
    difficultyType: "decreasing",
  },
  AutoTransferMasterCheckIntervalSeconds: {
    ...
    type: "float",
    range: [60, 86400],
    desc: "Interval for checking guild master auto-transfer eligibility.",
  },
  AutoTransferMasterThresholdDays: {
    ...
    type: "integer",
    range: [1, 365],
    desc: "Days of guild master offline before auto-transfer.",
  },
  MaxGuildsPerFrame: {
    ...
    type: "integer",
    range: [1, 100],
    desc: "Maximum number of guilds processed per frame.",
  },
  bEnableVoiceChat: {
    ...
    defaultValue: "False",
    type: "boolean",
    desc: "Enable in-game voice chat.",
  },
  VoiceChatMaxVolumeDistance: {
    ...
    type: "float",
    range: [100, 50000],
    desc: "Distance at which voice chat volume does not attenuate.",
  },
  VoiceChatZeroVolumeDistance: {
    ...
    type: "float",
    range: [100, 50000],
    desc: "Distance at which voice chat volume becomes zero.",
  },
  bEnableBuildingPlayerUIdDisplay: {
    ...
    defaultValue: "False",
    type: "boolean",
    desc: "Whether to display the creator's player ID on structures.",
  },
  BuildingNameDisplayCacheTTLSeconds: {
    ...
    type: "integer",
    range: [1, 3600],
    desc: "TTL in seconds for building name display cache.",
  },
};
